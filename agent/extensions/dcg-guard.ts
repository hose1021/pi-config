...
//
// Official Pi integration recipe from dcg's docs/pi-integration.md.
// Routes every `bash` tool call through `dcg --robot test <command>` before
// execution and blocks the call when dcg denies it.
