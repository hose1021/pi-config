...
> Default to applying these rules while working. Only ask about during-vs-after on the first UI task per project.
...
Default to DURING (apply while working). Only switch to AFTER when the user asks for an audit of finished work.
