...
## Steps
1. Read `rules/tokens-and-color.md` → "Token System" + "Color Guidelines" and `rules/typography-and-spacing.md` for the rules (4px base, Major Third scale, OKLCH palette generation, dark-mode-at-semantic-layer).
