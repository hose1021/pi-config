...
description: "Build high-converting landing pages: intake, page structure, layout, copy, SEO, and visual rules. Use for new landing pages, landing copy, or landing design tokens."
---
...
Apply to landing pages and marketing sites (plus landing copy reviews). For other web UI, borrow only the visual system in Part B. When a rule here conflicts with a framework default, this file wins. When the user's explicit prompt conflicts with a rule, the user wins.
